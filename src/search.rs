...
tunables!(
    ...
    (NMP_EVAL_DIV, 131, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 26, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 118, 40, 200, 20.0, true),
    ...
    (HIST_PRUNE_MULT, 8975, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8168, 2000, 100000, 4900.0, true),
    ...
    (PROBCUT_MARGIN, 175, 80, 300, 11.0, true),
    ...
    (CORR_W_CONT, 43, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 317, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1937, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1926, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1497, 256, 4096, 192.0, true),
    ...
    (FUT_THREATS_MARGIN, 29, 0, 200, 10.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 22, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
