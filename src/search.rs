...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 16, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 122, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 19, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 88, 40, 200, 20.0, true),
    (RFP_DEPTH, 15, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 36, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 79, 50, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 14550, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8564, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 136, 40, 300, 13.0, true),
    ...
    (SE_DEPTH_10X, 50, 40, 200, 20.0, true),
    ...
    (LMP_DEPTH, 13, 4, 20, 2.0, true),
    (BAD_NOISY_MARGIN, 72, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 193, 80, 300, 11.0, true),
    ...
    (CORR_W_PAWN, 265, 100, 600, 25.0, true),
    (CORR_W_NP, 58, 50, 400, 17.5, true),
    (CORR_W_MINOR, 41, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 106, 30, 300, 13.5, true),
    (CORR_W_CONT, 50, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 324, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1829, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 293, 50, 400, 17.5, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 23, 0, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 78, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 19, 0, 400, 20.0, true),
    ...
    // changes.
    (IIR_MIN_DEPTH_10X, 25, 20, 100, 15.0, true),         // was hardcoded 4; tune #743 converged to 2 (strong signal)
    (PROBCUT_MIN_DEPTH_10X, 32, 30, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (SEE_CAP_DEPTH, 4, 3, 15, 1.5, true),         // was hardcoded 6 (SEE capture prune depth cap)
    (FUT_LMR_DEPTH, 13, 5, 20, 1.5, false),        // was hardcoded 10; tune #743 → 9
    (BAD_NOISY_DEPTH, 12, 4, 15, 1.5, true),       // was hardcoded 4 (BNFP depth cap)
    ...
    (NMP_MIN_DEPTH_10X, 81, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 24, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
