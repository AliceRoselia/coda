...
tunables!(
    ...
    (NMP_EVAL_DIV, 116, 50, 400, 17.5, true),
    ...
    (RFP_MARGIN_NOIMP, 31, 0, 200, 7.5, true),
    ...
    (RAZOR_MULT, 289, 100, 500, 20.0, true),
    ...
    (LMR_HIST_DIV, 13603, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1729, 1000, 20000, 1500.0, true),
    ...
    (HINDSIGHT_THRESH, 195, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 87, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 297, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1393, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 318, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1878, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1256, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 278, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1941, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 249, 64, 1024, 40.0, true),
    ...
    (DEXT_MARGIN_QUIET, 13, 0, 100, 4.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 63, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 856, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 60, 20, 90, 15.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 47, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (NMP_MIN_DEPTH_10X, 44, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
