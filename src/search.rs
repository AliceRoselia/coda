...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 50, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 121, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 21, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 89, 40, 200, 20.0, true),
    (RFP_DEPTH, 17, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 31, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 82, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 50, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 81, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 12, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 11828, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 31, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8486, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 127, 40, 300, 13.0, true),
    (LMR_C_CAP, 119, 80, 350, 12.5, true),
    ...
    (PROBCUT_MARGIN, 197, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 132, 50, 400, 17.5, true),
    ...
    (CORR_W_NP, 68, 50, 400, 17.5, true),
    (CORR_W_MINOR, 62, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 92, 30, 300, 13.5, true),
    (CORR_W_CONT, 47, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 318, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1720, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1753, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 206, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1192, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 46, 20, 90, 15.0, true),
    ...
    (LMR_THREAT_DIV_10X, 44, 10, 50, 15.0, true),
