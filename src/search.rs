...
tunables!(
    ...
    (HIST_BONUS_MAX, 1749, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 23, 0, 400, 25.0),
    (CAP_HIST_MULT, 272, 50, 400, 17.5),
    ...
    (QUIET_CHECK_BONUS, 10916, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 187, 30, 500, 23.5),
    (CORR_HIST_DIV, 1256, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 16376, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10628, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5879, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5628, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7788, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6651, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8968, 0, 20000, 1000.0),
