...
tunables!(
    ...
    (NMP_BASE_R_10X, 65, 20, 80, 15.0, true),
    (NMP_DEPTH_DIV_10X, 36, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 108, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 22, 10, 60, 5.0, true),
    ...
    (HIST_PRUNE_MULT, 14201, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7497, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 137, 40, 300, 13.0, true),
    (LMR_C_CAP, 107, 80, 350, 12.5, true),
    ...
    (PROBCUT_MARGIN, 192, 80, 300, 11.0, true),
    ...
    (CORR_W_MINOR, 53, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 97, 30, 300, 13.5, true),
    (CORR_W_CONT, 50, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 322, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1733, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 273, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 37, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1768, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 193, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1209, 256, 4096, 192.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 63, 20, 90, 15.0, true),
    ...
    (LMR_ENDGAME_PIECES_10X, 44, 40, 90, 15.0, true),
    ...
    // changes.
    (IIR_MIN_DEPTH_10X, 22, 20, 100, 15.0, true),         // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 31, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
