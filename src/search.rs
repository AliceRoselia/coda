...
tunables!(
    ...
    (NMP_EVAL_DIV, 148, 50, 400, 17.5, true),
    ...
    (HIST_PRUNE_MULT, 8849, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7102, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 4921, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 148, 40, 300, 13.0, true),
    ...
    (CORR_W_CONT, 39, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1824, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1852, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1569, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 69, 20, 90, 15.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 43, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 32, 0, 400, 20.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 16, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 11, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
