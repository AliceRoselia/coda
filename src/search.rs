...
tunables!(
    ...
    (NMP_BASE_R_10X, 62, 20, 80, 15.0),
    (NMP_DEPTH_DIV_10X, 54, 10, 60, 15.0),
    (NMP_EVAL_DIV, 97, 50, 400, 17.5),
    (NMP_EVAL_MAX_10X, 22, 10, 60, 5.0),
    (NMP_VERIFY_DEPTH_10X, 115, 40, 200, 20.0),
    ...
    (FUT_PER_DEPTH, 100, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH_10X, 12, 10, 80, 15.0),
    (HIST_PRUNE_MULT, 11227, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 31, 5, 80, 3.75),
    (LMR_HIST_DIV, 7250, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 32474, 8000, 50000, 2100.0),
    ...
    (LMP_DEPTH, 5, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 80, 30, 150, 6.0),
    (PROBCUT_MARGIN, 177, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 157, 50, 400, 17.5),
    (UNSTABLE_THRESH, 301, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 220, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 364, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -32, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 21, 2, 32, 2.0),
    (CORR_W_PAWN, 282, 100, 600, 25.0),
    (CORR_W_NP, 66, 50, 400, 17.5),
    (CORR_W_MINOR, 52, 30, 300, 13.5),
    (CORR_W_MAJOR, 75, 30, 300, 13.5),
    (CORR_W_CONT, 45, 30, 400, 18.5),
    (FH_BLEND_DEPTH_10X, 33, 0, 80, 15.0),
    (HIST_BONUS_MULT, 301, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1869, 500, 3000, 125.0),
    ...
    (CAP_HIST_MULT, 315, 50, 400, 17.5),
    (CAP_HIST_BASE, 45, 0, 200, 10.0),
    (CAP_HIST_MAX, 1807, 500, 3000, 125.0),
    ...
    (NFH_CAP_10X, 35, 10, 60, 10.0),
    (NFH_DIV_10X, 36, 20, 120, 10.0),
    ...
    (DEXT_MARGIN_PV, 168, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 10, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 20, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 47, -50, 150, 6.0),
    (DEXT_CAP, 12, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 14979, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 177, 30, 500, 23.5),
    (CORR_HIST_DIV, 1481, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 12, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV_10X, 51, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 14, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 26, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 18803, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 8964, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 6698, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX_10X, 79, 20, 90, 15.0),
    ...
    (MOBILITY_DELTA_WEIGHT, 41, 0, 256, 8.0),
    (PROBCUT_KING_ZONE_MAX_10X, 56, 20, 90, 15.0),
    (LMR_THREAT_DIV_10X, 48, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV_10X, 71, 20, 90, 15.0),
    (FUT_THREATS_MARGIN, 22, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 4964, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8091, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6220, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 60, 0, 400, 20.0),
    (MVV_CAP_MULT, 30, 4, 64, 3.0),
    (CONT_HIST_MULT_10X, 11, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 8059, 0, 20000, 1000.0),
    ...
    (PROBCUT_MIN_DEPTH_10X, 32, 30, 120, 15.0),     // was hardcoded 5 (ProbCut activation gate)
    (SEE_CAP_DEPTH, 5, 3, 15, 1.5),         // was hardcoded 6 (SEE capture prune depth cap)
    (FUT_LMR_DEPTH, 11, 5, 20, 1.5),         // was hardcoded 10; tune #743 → 9
    ...
    (NMP_MIN_DEPTH_10X, 76, 20, 200, 15.0),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 29, 10, 200, 15.0),        // was hardcoded 2 (hindsight reduction gate)
