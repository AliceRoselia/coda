...
tunables!(
    ...
    (FUT_BASE, 20, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 83, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 9576, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 33, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8332, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5465, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 130, 40, 300, 13.0, true),
    ...
    (PROBCUT_MARGIN, 196, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 176, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 15, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1920, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1815, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 154, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1565, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 13, 0, 50, 10.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 65, 20, 90, 15.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 35, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
