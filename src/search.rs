...
tunables!(
    ...
    (RFP_MARGIN_IMP, 32, 0, 150, 6.0, true),
    ...
    (LMR_HIST_DIV, 7097, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3938, 1000, 20000, 1500.0, true),
    ...
    (HINDSIGHT_THRESH, 190, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 62, 0, 400, 18.5, true),
