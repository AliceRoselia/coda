...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 77, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 154, 50, 400, 17.5, true),
    ...
    (RFP_MARGIN_NOIMP, 51, 0, 200, 7.5, true),
    ...
    (FUT_BASE, 21, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 76, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 10811, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 37, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7608, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3633, 1000, 20000, 1500.0, true),
    ...
    (HIST_BONUS_MULT, 323, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 2002, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1531, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 29, 0, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 72, 20, 90, 15.0, true),
