...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 60, 10, 60, 15.0, true),
    ...
    (RFP_MARGIN_NOIMP, 56, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 22, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 83, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 9294, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8982, 2000, 100000, 4900.0, true),
    ...
    (CORR_W_MINOR, 5, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 3, 30, 300, 13.5, true),
    (CORR_W_CONT, 36, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 33, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 312, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1908, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1548, 256, 4096, 192.0, true),
