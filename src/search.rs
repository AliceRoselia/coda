...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 38, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 113, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 21, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 70, 40, 200, 20.0, true),
    (RFP_DEPTH, 16, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 30, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 77, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 41, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 74, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 13, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 15073, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 6243, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 141, 40, 300, 13.0, true),
    (LMR_C_CAP, 94, 80, 350, 12.5, true),
    ...
    (LMP_DEPTH, 10, 4, 20, 2.0, true),
    (BAD_NOISY_MARGIN, 75, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 200, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 154, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 209, 50, 500, 22.5, false),
    (SEE_MATERIAL_SCALE, 228, 30, 300, 13.5, false),
    (QS_DELTA_MARGIN, 365, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -37, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 29, 2, 32, 2.0, false),
    (CORR_W_PAWN, 243, 100, 600, 25.0, true),
    (CORR_W_NP, 75, 50, 400, 17.5, true),
    (CORR_W_MINOR, 67, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 86, 30, 300, 13.5, true),
    (CORR_W_CONT, 41, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 334, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1687, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 284, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 37, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1687, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 189, 50, 400, 15.0, true),
    ...
    (LMR_COMPLEXITY_DIV, 204, 30, 500, 23.5, true),
    (CORR_HIST_DIV, 1415, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 12, 4, 48, 2.2, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 75, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 26, 0, 50, 10.0, true),
    ...
    (FUT_THREATS_MARGIN, 11, 0, 200, 10.0, true),
    ...
    (CONT_HIST_MULT_10X, 12, 10, 80, 15.0, true),
    ...
    // changes.
    (IIR_MIN_DEPTH_10X, 21, 20, 100, 15.0, true),         // was hardcoded 4; tune #743 converged to 2 (strong signal)
    (PROBCUT_MIN_DEPTH_10X, 33, 30, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (SEE_CAP_DEPTH, 6, 3, 15, 1.5, true),         // was hardcoded 6 (SEE capture prune depth cap)
    (FUT_LMR_DEPTH, 12, 5, 20, 1.5, true),         // was hardcoded 10; tune #743 → 9
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 26, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
