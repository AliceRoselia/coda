...
tunables!(
    ...
    (NMP_EVAL_DIV, 139, 50, 400, 17.5, true),
    ...
    (RFP_MARGIN_IMP, 42, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 53, 0, 200, 7.5, true),
    ...
    (FUT_BASE, 25, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 76, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 11, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 10214, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8520, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5174, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 141, 40, 300, 13.0, true),
    (LMR_C_CAP, 116, 80, 350, 12.5, true),
    ...
    (PROBCUT_MARGIN, 186, 80, 300, 11.0, true),
    ...
    (CORR_W_PAWN, 319, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 44, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1854, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1872, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1661, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 14, 0, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 55, 20, 90, 15.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 16, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
