...
tunables!(
    ...
    (RFP_DEEP_QUAD, 14, 0, 80, 5.0, true),
    ...
    (FUT_PER_DEPTH, 112, 40, 250, 10.5, true),
    ...
    (LMR_HIST_DIV, 9034, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3695, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 137, 40, 300, 13.0, true),
    (LMR_C_CAP, 160, 80, 350, 12.5, true),
    ...
    (PROBCUT_MARGIN, 123, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 170, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 339, 100, 500, 20.0, true),
    ...
    (HIST_BONUS_MAX, 1554, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1828, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 329, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1486, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 311, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1906, 500, 4000, 175.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 28, 1, 50, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 36, 0, 400, 20.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 30, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 21, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
