...
tunables!(
    ...
    (NMP_EVAL_DIV, 123, 50, 400, 17.5, true),
    ...
    (NMP_VERIFY_DEPTH_10X, 123, 40, 200, 20.0, true),
    ...
    (RAZOR_MULT, 267, 100, 500, 20.0, true),
    ...
    (LMR_HIST_DIV, 8648, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3199, 1000, 20000, 1500.0, true),
    ...
    (SE_DEPTH_10X, 47, 40, 200, 20.0, true),
    ...
    (BAD_NOISY_MARGIN, 66, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 109, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 181, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 60, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1563, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1888, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 316, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1416, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 287, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 2104, 500, 4000, 175.0, true),
    ...
    (DEXT_MARGIN_QUIET, 10, 0, 100, 4.0, true),
    ...
    (CORR_HIST_DIV, 1568, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 88, 20, 90, 15.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 40, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 8, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
