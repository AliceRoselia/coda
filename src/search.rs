...
tunables!(
    ...
    (RFP_MARGIN_IMP, 36, 30, 150, 6.0),
    (RFP_MARGIN_NOIMP, 70, 50, 200, 7.5),
    ...
    (FUT_BASE, 23, 20, 200, 9.0),
    (FUT_PER_DEPTH, 94, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 1, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 13090, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 33, 5, 80, 3.75),
    (LMR_HIST_DIV, 7767, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 137, 40, 300, 13.0),
    ...
    (ASP_SCORE_DIV, 34570, 8000, 50000, 2100.0),
    ...
    (UNSTABLE_THRESH, 324, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 212, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 365, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -36, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 23, 2, 32, 2.0),
    (CORR_W_PAWN, 268, 100, 600, 25.0),
    (CORR_W_NP, 85, 50, 400, 17.5),
    (CORR_W_MINOR, 47, 30, 300, 13.5),
    (CORR_W_MAJOR, 87, 30, 300, 13.5),
    (CORR_W_CONT, 37, 30, 400, 18.5),
    (FH_BLEND_DEPTH_10X, 29, 0, 80, 15.0),
    (HIST_BONUS_MULT, 293, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1947, 500, 3000, 125.0),
    ...
    (CAP_HIST_BASE, 47, 0, 200, 10.0),
    (CAP_HIST_MAX, 1900, 500, 3000, 125.0),
    ...
    (NFH_CAP_10X, 37, 10, 60, 10.0),
    (NFH_DIV_10X, 46, 20, 120, 10.0),
    ...
    (QUIET_CHECK_BONUS, 15202, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 162, 30, 500, 23.5),
    (CORR_HIST_DIV, 1422, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 12, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV_10X, 43, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 14, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 27, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 19203, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 8722, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5008, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX, 8, 2, 9, 1.5),
    ...
    (NMP_UNDEFENDED_MAX_10X, 14, 0, 50, 10.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 3748, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8594, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6504, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 65, 0, 400, 20.0),
    (MVV_CAP_MULT, 30, 4, 64, 3.0),
    (CONT_HIST_MULT_10X, 10, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 8769, 0, 20000, 1000.0),
    ...
    (LMR_ENDGAME_PIECES_10X, 45, 40, 90, 15.0),
    ...
    // changes.
    (IIR_MIN_DEPTH_10X, 22, 20, 100, 15.0),         // was hardcoded 4; tune #743 converged to 2 (strong signal)
    (PROBCUT_MIN_DEPTH_10X, 35, 30, 120, 15.0),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 28, 10, 200, 15.0),        // was hardcoded 2 (hindsight reduction gate)
