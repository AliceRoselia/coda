...
tunables!(
    ...
    (NMP_EVAL_DIV, 111, 50, 400, 17.5, true),
    ...
    (FUT_BASE, 42, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 75, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 13, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 15089, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 5697, 2000, 100000, 4900.0, true),
    ...
    (QS_DELTA_MARGIN, 364, 100, 500, 20.0, true),
    ...
    (CORR_W_MINOR, 66, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 85, 30, 300, 13.5, true),
    (CORR_W_CONT, 40, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 336, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1688, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1679, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 190, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1406, 256, 4096, 192.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 77, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 12, 0, 200, 10.0, true),
    ...
    (CONT_HIST_MULT_10X, 14, 10, 80, 15.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 34, 30, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 80, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
