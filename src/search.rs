...
tunables!(
    ...
    (NMP_BASE_R_10X, 73, 20, 80, 15.0),
    (NMP_DEPTH_DIV_10X, 39, 10, 60, 15.0),
    (NMP_EVAL_DIV, 122, 50, 400, 17.5),
    (NMP_EVAL_MAX_10X, 23, 10, 60, 5.0),
    (NMP_VERIFY_DEPTH_10X, 113, 40, 200, 20.0),
    (RFP_DEPTH, 17, 2, 20, 2.0),
    (RFP_MARGIN_IMP, 33, 30, 150, 6.0),
    (RFP_MARGIN_NOIMP, 64, 50, 200, 7.5),
    ...
    (FUT_PER_DEPTH, 94, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH_10X, 11, 10, 80, 15.0),
    (HIST_PRUNE_MULT, 11963, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 8086, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 33930, 8000, 50000, 2100.0),
    ...
    (PROBCUT_MARGIN, 186, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 151, 50, 400, 17.5),
    ...
    (CORR_W_NP, 72, 50, 400, 17.5),
    (CORR_W_MINOR, 45, 30, 300, 13.5),
    (CORR_W_MAJOR, 105, 30, 300, 13.5),
    (CORR_W_CONT, 42, 30, 400, 18.5),
    (FH_BLEND_DEPTH_10X, 34, 0, 80, 15.0),
    (HIST_BONUS_MULT, 304, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1874, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 8, 0, 400, 25.0),
    (CAP_HIST_MULT, 314, 50, 400, 17.5),
    (CAP_HIST_BASE, 33, 0, 200, 10.0),
    (CAP_HIST_MAX, 1880, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 164, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 8, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 23, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 41, -50, 150, 6.0),
    (DEXT_CAP, 13, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 14574, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 152, 30, 500, 23.5),
    (CORR_HIST_DIV, 1478, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 13, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV_10X, 49, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 14, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 28, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 17944, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 9239, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5435, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX_10X, 78, 20, 90, 15.0),
    ...
    (NMP_UNDEFENDED_MAX_10X, 18, 0, 50, 10.0),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 68, 20, 90, 15.0),
    (LMR_THREAT_DIV_10X, 46, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV_10X, 71, 20, 90, 15.0),
    (FUT_THREATS_MARGIN, 16, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 3532, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8435, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6743, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 61, 0, 400, 20.0),
    (MVV_CAP_MULT, 30, 4, 64, 3.0),
    (CONT_HIST_MULT_10X, 10, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 9443, 0, 20000, 1000.0),
    ...
    (LMR_ENDGAME_PIECES_10X, 44, 40, 90, 15.0),
    ...
    (NMP_MIN_DEPTH_10X, 69, 20, 200, 15.0),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 34, 10, 200, 15.0),        // was hardcoded 2 (hindsight reduction gate)
