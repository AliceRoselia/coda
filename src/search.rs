...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 81, 50, 200, 7.5),
    ...
    (HIST_PRUNE_MULT, 13650, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 7368, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 29623, 8000, 50000, 2100.0),
    ...
    (HINDSIGHT_THRESH, 153, 50, 400, 17.5),
    (UNSTABLE_THRESH, 199, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 235, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 352, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -37, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 28, 2, 32, 2.0),
    (CORR_W_PAWN, 279, 100, 600, 25.0),
    (CORR_W_NP, 80, 50, 400, 17.5),
    (CORR_W_MINOR, 65, 30, 300, 13.5),
    (CORR_W_MAJOR, 106, 30, 300, 13.5),
    (CORR_W_CONT, 40, 30, 400, 18.5),
    (FH_BLEND_DEPTH, 3, 0, 8, 1.5),
    (HIST_BONUS_MULT, 323, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1735, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 15, 0, 400, 25.0),
    (CAP_HIST_MULT, 281, 50, 400, 17.5),
    (CAP_HIST_BASE, 35, 0, 200, 10.0),
    (CAP_HIST_MAX, 1636, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 11173, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 181, 30, 500, 23.5),
    (CORR_HIST_DIV, 1204, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 10, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV, 1, 1, 16, 1.5),
    (CORR_HIST_GRAIN_T, 11, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 20, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 15506, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10834, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5767, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6157, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7359, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6415, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 9126, 0, 20000, 1000.0),
    ...
    (HINDSIGHT_MIN_DEPTH, 5, 1, 20, 1.5),        // was hardcoded 2 (hindsight reduction gate)
