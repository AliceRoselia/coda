...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 51, 10, 200, 15.0, true),
    ...
    (FUT_BASE, 26, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 76, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 9643, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 9310, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5674, 1000, 20000, 1500.0, true),
    ...
    (HINDSIGHT_THRESH, 163, 50, 400, 17.5, true),
    ...
    (CAP_HIST_MAX, 1859, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 157, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 0, 0, 100, 4.0, true),
    ...
    (CORR_HIST_DIV, 1534, 256, 4096, 192.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 72, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 21, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
