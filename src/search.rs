...
tunables!(
    ...
    (NMP_VERIFY_DEPTH_10X, 69, 40, 200, 20.0, true),
    ...
    (LMR_HIST_DIV, 8257, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 4693, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 129, 40, 300, 13.0, true),
    (LMR_C_CAP, 156, 80, 350, 12.5, true),
    ...
    (PROBCUT_MARGIN, 137, 80, 300, 11.0, true),
    ...
    (CORR_W_CONT, 45, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1709, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 299, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1923, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1533, 256, 4096, 192.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 62, 0, 400, 20.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 82, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 2, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
