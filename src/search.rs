...
tunables!(
    ...
    (CORR_W_NP, 59, 50, 400, 17.5),
    (CORR_W_MINOR, 57, 30, 300, 13.5),
    (CORR_W_MAJOR, 99, 30, 300, 13.5),
    (CORR_W_CONT, 50, 30, 400, 18.5),
    (FH_BLEND_DEPTH, 4, 0, 8, 1.5),
    (HIST_BONUS_MULT, 312, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1737, 500, 3000, 125.0),
    ...
    (CAP_HIST_MAX, 1673, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 11733, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 171, 30, 500, 23.5),
    (CORR_HIST_DIV, 1277, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15738, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10835, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5239, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6860, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8539, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6654, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 9138, 0, 20000, 1000.0),
