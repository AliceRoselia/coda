...
tunables!(
    ...
    (FUT_BASE, 28, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 82, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 11578, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 37, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8191, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 133, 40, 300, 13.0, true),
    (LMR_C_CAP, 102, 80, 350, 12.5, true),
    ...
    (QS_DELTA_MARGIN, 356, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -26, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 24, 2, 32, 2.0, false),
    (CORR_W_PAWN, 295, 100, 600, 25.0, true),
    (CORR_W_NP, 70, 50, 400, 17.5, true),
    ...
    (CORR_W_MINOR, 1, 0, 300, 13.5, true),
    (CORR_W_MAJOR, 6, 0, 300, 13.5, true),
    (CORR_W_CONT, 31, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 33, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 313, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1968, 500, 3000, 125.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 6, 0, 50, 10.0, true),
    ...
    (FUT_THREATS_MARGIN, 26, 0, 200, 10.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 32, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
