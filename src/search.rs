...
tunables!(
    ...
    (NMP_BASE_R_10X, 60, 20, 80, 15.0, true),
    ...
    (NMP_EVAL_DIV, 132, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 24, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 114, 40, 200, 20.0, true),
    (RFP_DEPTH, 15, 2, 20, 2.0, true),
    // Floors lifted to 0 (audit 2026-05-20): both pinned within ~10% of floor.
    (RFP_MARGIN_IMP, 39, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 50, 0, 200, 7.5, true),
    ...
    (FUT_PER_DEPTH, 71, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 9628, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8218, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5450, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 135, 40, 300, 13.0, true),
    ...
    (CORR_W_CONT, 54, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 306, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1910, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 287, 50, 400, 17.5, true),
    ...
    (DEXT_MARGIN_PV, 161, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1671, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 62, 20, 90, 15.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 11, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 77, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 29, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
