...
tunables!(
    ...
    (CAP_HIST_MAX, 1647, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 209, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 6, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 14, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 40, -50, 150, 6.0),
    (DEXT_CAP, 13, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 11879, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 185, 30, 500, 23.5),
    (CORR_HIST_DIV, 1207, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15649, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10729, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5888, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5830, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7548, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8876, 0, 20000, 1000.0),
