...
tunables!(
    ...
    (FUT_PER_DEPTH, 81, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 2, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 14020, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75),
    (LMR_HIST_DIV, 7359, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 137, 40, 300, 13.0),
    (LMR_C_CAP, 111, 80, 350, 12.5),
    (SE_DEPTH, 5, 2, 20, 2.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 29806, 8000, 50000, 2100.0),
    (LMP_BASE, 8, 1, 15, 2.0),
    (LMP_DEPTH, 11, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 71, 30, 150, 6.0),
    (PROBCUT_MARGIN, 195, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 146, 50, 400, 17.5),
    (UNSTABLE_THRESH, 219, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 227, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 354, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -40, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 27, 2, 32, 2.0),
    (CORR_W_PAWN, 241, 100, 600, 25.0),
    ...
    (HIST_BONUS_MAX, 1791, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 17, 0, 400, 25.0),
    (CAP_HIST_MULT, 273, 50, 400, 17.5),
    (CAP_HIST_BASE, 36, 0, 200, 10.0),
    (CAP_HIST_MAX, 1570, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 191, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 8, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 15, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 42, -50, 150, 6.0),
    (DEXT_CAP, 13, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 11838, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 197, 30, 500, 23.5),
    (CORR_HIST_DIV, 1229, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 16163, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 11136, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5566, 2000, 20000, 900.0),
    ...
    (FUT_THREATS_MARGIN, 11, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 5256, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8568, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6166, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8349, 0, 20000, 1000.0),
    ...
    // changes.
    (IIR_MIN_DEPTH, 1, 1, 10, 1.5),         // was hardcoded 4; tune #743 converged to 2 (strong signal); min widened 2026-05-08
    (PROBCUT_MIN_DEPTH, 2, 2, 12, 1.5),     // was hardcoded 5 (ProbCut activation gate); min widened 2026-05-08
    ...
    (TT_CUTOFF_HALFMOVE_MAX, 83, 50, 100, 3.0),  // was hardcoded 90 (TT cutoff halfmove gate, 5 sites)
);
