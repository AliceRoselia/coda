...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 57, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 118, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 25, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 98, 40, 200, 20.0, true),
    (RFP_DEPTH, 19, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 43, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 57, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 38, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 80, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 11753, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8763, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 129, 40, 300, 13.0, true),
    (LMR_C_CAP, 110, 80, 350, 12.5, true),
    ...
    (BAD_NOISY_MARGIN, 89, 30, 150, 6.0, true),
    ...
    (QS_DELTA_MARGIN, 384, 100, 500, 20.0, true),
    ...
    (CORR_W_MAJOR, 89, 30, 300, 13.5, true),
    (CORR_W_CONT, 52, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 33, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 339, 50, 400, 17.5, true),
    ...
    (CAP_HIST_MULT, 295, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 42, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1832, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 151, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1520, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 64, 20, 90, 15.0, true),
    (LMR_THREAT_DIV_10X, 50, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 53, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 17, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 61, 0, 400, 20.0, true),
    ...
    (NMP_GATE_BASE, 380, 0, 800, 30.0, true),
    (NMP_GATE_DEPTH_K, 15, 0, 40, 2.0, true),
    (NMP_GATE_IMPROVING_K, 56, 0, 120, 5.0, true),
);
