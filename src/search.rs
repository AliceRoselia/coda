...
tunables!(
    ...
    (FH_BLEND_DEPTH, 4, 0, 8, 1.5),
    (HIST_BONUS_MULT, 334, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1750, 500, 3000, 125.0),
    ...
    (CAP_HIST_MAX, 1713, 500, 3000, 125.0),
    ...
    (ESCAPE_BONUS_Q, 15741, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10756, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 6054, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6225, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7709, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6525, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8925, 0, 20000, 1000.0),
