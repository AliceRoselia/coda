...
tunables!(
    ...
    (NMP_EVAL_DIV, 178, 50, 400, 17.5),
    (NMP_EVAL_MAX, 4, 1, 6, 1.5),
    (NMP_VERIFY_DEPTH, 10, 4, 20, 2.0),
    (RFP_DEPTH, 11, 2, 20, 2.0),
    (RFP_MARGIN_IMP, 33, 30, 150, 6.0),
    (RFP_MARGIN_NOIMP, 74, 50, 200, 7.5),
    ...
    (HIST_PRUNE_MULT, 10765, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75),
    (LMR_HIST_DIV, 7775, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 30047, 8000, 50000, 2100.0),
    ...
    // Bisecting 9 → 5 first.
    (LMP_BASE, 9, 1, 15, 2.0),
    (LMP_DEPTH, 17, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 65, 30, 150, 6.0),
    (PROBCUT_MARGIN, 228, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 177, 50, 400, 17.5),
    (UNSTABLE_THRESH, 195, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 232, 30, 300, 13.5),
    ...
    (CORR_W_MINOR, 55, 30, 300, 13.5),
    (CORR_W_MAJOR, 56, 30, 300, 13.5),
    (CORR_W_CONT, 58, 30, 400, 18.5),
    (FH_BLEND_DEPTH_10X, 10, 0, 80, 15.0),
    (HIST_BONUS_MULT, 300, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1927, 500, 3000, 125.0),
    ...
    (CAP_HIST_MULT, 248, 50, 400, 17.5),
    (CAP_HIST_BASE, 4, 0, 200, 10.0),
    (CAP_HIST_MAX, 2460, 500, 3000, 125.0),
    ...
    (NFH_CAP_10X, 50, 10, 60, 10.0),
    (NFH_DIV_10X, 30, 20, 120, 10.0),
    ...
    (DEXT_MARGIN_PV, 218, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 22, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 15, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 48, -50, 150, 6.0),
    (DEXT_CAP, 7, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 14438, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 183, 30, 500, 23.5),
    (CORR_HIST_DIV, 1566, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 9, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV_10X, 50, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 11, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 230, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 17430, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 12431, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5387, 2000, 20000, 900.0),
    ...
    (MOBILITY_DELTA_WEIGHT, 57, 0, 256, 8.0),
    (PROBCUT_KING_ZONE_MAX, 6, 2, 9, 1.5),
    (LMR_THREAT_DIV_10X, 30, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV, 8, 2, 9, 1.5),
    (FUT_THREATS_MARGIN, 15, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 5296, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8556, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 5488, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 10760, 0, 20000, 1000.0),
    ...
    (PROBCUT_MIN_DEPTH_10X, 40, 30, 120, 15.0),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 20, 10, 200, 15.0),        // was hardcoded 2 (hindsight reduction gate)
    (TT_CUTOFF_HALFMOVE_MAX, 84, 50, 100, 3.0),  // was hardcoded 90 (TT cutoff halfmove gate, 5 sites)
);
