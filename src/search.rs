...
tunables!(
    ...
    (HIST_PRUNE_MULT, 14336, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 29, 5, 80, 3.75),
    (LMR_HIST_DIV, 7530, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 138, 40, 300, 13.0),
    (LMR_C_CAP, 100, 80, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 31117, 8000, 50000, 2100.0),
    (LMP_BASE, 8, 1, 15, 2.0),
    (LMP_DEPTH, 11, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 74, 30, 150, 6.0),
    (PROBCUT_MARGIN, 189, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 138, 50, 400, 17.5),
    (UNSTABLE_THRESH, 230, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 242, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 351, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -40, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 28, 2, 32, 2.0),
    (CORR_W_PAWN, 285, 100, 600, 25.0),
    (CORR_W_NP, 88, 50, 400, 17.5),
    (CORR_W_MINOR, 64, 30, 300, 13.5),
    (CORR_W_MAJOR, 103, 30, 300, 13.5),
    (CORR_W_CONT, 44, 30, 400, 18.5),
    (FH_BLEND_DEPTH, 3, 0, 8, 1.5),
    (HIST_BONUS_MULT, 318, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1793, 500, 3000, 125.0),
    ...
    (CAP_HIST_BASE, 25, 0, 200, 10.0),
    (CAP_HIST_MAX, 1781, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 12149, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 181, 30, 500, 23.5),
    (CORR_HIST_DIV, 1293, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 16358, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 9993, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5406, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5206, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7232, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6685, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 9217, 0, 20000, 1000.0),
