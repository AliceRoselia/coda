...
tunables!(
    ...
    (NMP_VERIFY_DEPTH_10X, 92, 40, 200, 20.0, true),
    ...
    (LMR_HIST_DIV, 9505, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3209, 1000, 20000, 1500.0, true),
    ...
    (CORR_W_CONT, 63, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1637, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1891, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 312, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1411, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 324, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1946, 500, 4000, 175.0, true),
    ...
    (DEXT_MARGIN_BASE, 30, -50, 150, 6.0, true),
    (DEXT_CAP, 12, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (CORR_HIST_DIV, 1686, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 78, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 29, 0, 400, 20.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 15, 0, 200, 15.0, true),
