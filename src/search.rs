...
tunables!(
    ...
    (NMP_BASE_R_10X, 75, 20, 80, 15.0),
    (NMP_DEPTH_DIV_10X, 58, 10, 60, 15.0),
    (NMP_EVAL_DIV, 128, 50, 400, 17.5),
    (NMP_EVAL_MAX_10X, 24, 10, 60, 5.0),
    (NMP_VERIFY_DEPTH_10X, 117, 40, 200, 20.0),
    (RFP_DEPTH, 19, 2, 20, 2.0),
    (RFP_MARGIN_IMP, 31, 30, 150, 6.0),
    (RFP_MARGIN_NOIMP, 62, 50, 200, 7.5),
    ...
    (FUT_PER_DEPTH, 92, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0),
    (HIST_PRUNE_MULT, 12542, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75),
    (LMR_HIST_DIV, 8120, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 32321, 8000, 50000, 2100.0),
    ...
    (UNSTABLE_THRESH, 293, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 207, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 376, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -39, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 24, 2, 32, 2.0),
    (CORR_W_PAWN, 291, 100, 600, 25.0),
    (CORR_W_NP, 99, 50, 400, 17.5),
    (CORR_W_MINOR, 42, 30, 300, 13.5),
    (CORR_W_MAJOR, 92, 30, 300, 13.5),
    (CORR_W_CONT, 32, 30, 400, 18.5),
    (FH_BLEND_DEPTH_10X, 31, 0, 80, 15.0),
    (HIST_BONUS_MULT, 282, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1918, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 20, 0, 400, 25.0),
    (CAP_HIST_MULT, 294, 50, 400, 17.5),
    (CAP_HIST_BASE, 43, 0, 200, 10.0),
    (CAP_HIST_MAX, 1901, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 163, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 8, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 21, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 47, -50, 150, 6.0),
    (DEXT_CAP, 14, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 15811, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 162, 30, 500, 23.5),
    (CORR_HIST_DIV, 1301, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 12, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV_10X, 38, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 15, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 29, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 16650, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10320, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5949, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX_10X, 70, 20, 90, 15.0),
    ...
    (NMP_UNDEFENDED_MAX_10X, 10, 0, 50, 10.0),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 55, 20, 90, 15.0),
    (LMR_THREAT_DIV_10X, 49, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV_10X, 85, 20, 90, 15.0),
    (FUT_THREATS_MARGIN, 12, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 3300, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8873, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6359, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 72, 0, 400, 20.0),
    (MVV_CAP_MULT, 27, 4, 64, 3.0),
    (CONT_HIST_MULT_10X, 10, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 9589, 0, 20000, 1000.0),
    ...
    // changes.
    (IIR_MIN_DEPTH_10X, 21, 20, 100, 15.0),         // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (BAD_NOISY_DEPTH, 8, 4, 15, 1.5),       // was hardcoded 4 (BNFP depth cap)
    ...
    (NMP_MIN_DEPTH_10X, 59, 20, 200, 15.0),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 26, 10, 200, 15.0),        // was hardcoded 2 (hindsight reduction gate)
