...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 59, 10, 60, 15.0, true),
    ...
    (RFP_MARGIN_IMP, 41, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 60, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 35, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 84, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 10867, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7793, 2000, 100000, 4900.0, true),
    ...
    (SE_DEPTH_10X, 51, 40, 200, 20.0, true),
    ...
    (HINDSIGHT_THRESH, 160, 50, 400, 17.5, true),
    ...
    (CORR_W_NP, 64, 50, 400, 17.5, true),
    (CORR_W_MINOR, 58, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 86, 30, 300, 13.5, true),
    (CORR_W_CONT, 46, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 33, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 330, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1974, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 296, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 42, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1839, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 150, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1413, 256, 4096, 192.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 56, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 65, 0, 400, 20.0, true),
    ...
    (LMR_ENDGAME_PIECES_10X, 42, 40, 90, 15.0, true),
