...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 47, 10, 60, 15.0),
    (NMP_EVAL_DIV, 117, 50, 400, 17.5),
    (NMP_EVAL_MAX_10X, 22, 10, 60, 5.0),
    (NMP_VERIFY_DEPTH_10X, 123, 40, 200, 20.0),
    ...
    (FUT_BASE, 29, 20, 200, 9.0),
    (FUT_PER_DEPTH, 93, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH_10X, 12, 10, 80, 15.0),
    (HIST_PRUNE_MULT, 12676, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 31, 5, 80, 3.75),
    (LMR_HIST_DIV, 7697, 2000, 100000, 4900.0),
    ...
    (SE_DEPTH_10X, 42, 40, 200, 20.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 33901, 8000, 50000, 2100.0),
    ...
    (BAD_NOISY_MARGIN, 78, 30, 150, 6.0),
    (PROBCUT_MARGIN, 187, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 152, 50, 400, 17.5),
    (UNSTABLE_THRESH, 319, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 211, 30, 300, 13.5),
    ...
    (HIST_BONUS_MAX, 1889, 500, 3000, 125.0),
    ...
    (CAP_HIST_MULT, 308, 50, 400, 17.5),
    (CAP_HIST_BASE, 37, 0, 200, 10.0),
    (CAP_HIST_MAX, 1797, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 14748, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 163, 30, 500, 23.5),
    (CORR_HIST_DIV, 1409, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 18096, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 9114, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5817, 2000, 20000, 900.0),
    ...
    (NMP_UNDEFENDED_MAX_10X, 9, 0, 50, 10.0),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 62, 20, 90, 15.0),
    (LMR_THREAT_DIV_10X, 41, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV_10X, 82, 20, 90, 15.0),
    (FUT_THREATS_MARGIN, 18, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 3837, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8341, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6537, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 53, 0, 400, 20.0),
    (MVV_CAP_MULT, 29, 4, 64, 3.0),
    (CONT_HIST_MULT_10X, 10, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 8889, 0, 20000, 1000.0),
