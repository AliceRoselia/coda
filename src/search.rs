...
tunables!(
    ...
    (FUT_PER_DEPTH, 73, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 4, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 11565, 500, 50000, 2475.0),
    ...
    (ASP_SCORE_DIV, 30520, 8000, 50000, 2100.0),
    (LMP_BASE, 9, 1, 15, 2.0),
    ...
    (QS_DELTA_MARGIN, 349, 100, 500, 20.0),
    ...
    (HIST_BONUS_MAX, 1728, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 29, 0, 400, 25.0),
    (CAP_HIST_MULT, 270, 50, 400, 17.5),
    (CAP_HIST_BASE, 36, 0, 200, 10.0),
    (CAP_HIST_MAX, 1590, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 12066, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 176, 30, 500, 23.5),
    (CORR_HIST_DIV, 1307, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15806, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 11009, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5386, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5088, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7753, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6686, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8787, 0, 20000, 1000.0),
    ...
    // changes.
    (IIR_MIN_DEPTH, 2, 1, 10, 1.5),         // was hardcoded 4; tune #743 converged to 2 (strong signal); min widened 2026-05-08
    (PROBCUT_MIN_DEPTH, 3, 2, 12, 1.5),     // was hardcoded 5 (ProbCut activation gate); min widened 2026-05-08
