...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 28, 0, 200, 7.5, true),
    ...
    (RFP_ROOT_COEF, 29, 0, 150, 7.5, true),
    ...
    (RAZOR_MULT, 288, 100, 500, 20.0, true),
    ...
    (FUT_BASE, 67, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 90, 40, 250, 10.5, true),
    ...
    (SEE_QUIET_MULT, 27, 5, 80, 3.75, true),
    ...
    (LMR_HIST_DIV, 17571, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1113, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 140, 40, 300, 13.0, true),
    (LMR_C_CAP, 164, 80, 350, 12.5, true),
    ...
    (LMR_ROOT_COEF, 6, 0, 80, 4.0, true),
    (BAD_NOISY_MARGIN, 77, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 116, 80, 300, 11.0, true),
    ...
    (PROBCUT_ROOT_FADE, 5, 1, 12, 1.0, true),
    ...
    (CORR_W_PAWN, 270, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 82, 0, 400, 18.5, true),
    ...
    (CORR_W_TRANS, 70, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1468, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 317, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1854, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 309, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1380, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 328, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1838, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 281, 64, 1024, 40.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 65, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 828, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 75, 20, 90, 15.0, true),
    // Was 38 (tp10→4). Now FIXED-POINT. Default 40 → eff 4.0 ≡ old behavior.
    (LMR_THREAT_DIV_10X, 29, 10, 50, 15.0, true),
    // Was 68 (tp10→7). Now FIXED-POINT. Default 70 → eff 7.0 ≡ old behavior.
    (LMR_KING_PRESSURE_DIV_10X, 48, 20, 90, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 21, 0, 200, 10.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 50, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 20, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (PROBCUT_ROOT_MIN_DEPTH_10X, 33, 0, 80, 8.0, true),
    ...
    (SEE_CAP_MULT, 113, 40, 250, 12.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 47, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
