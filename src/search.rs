...
tunables!(
    ...
    (ESCAPE_BONUS_R, 8433, 3000, 30000, 1350.0, false),
    ...
    // current defaults.
    (ESCAPE_BONUS_Q, 17900, 0, 30000, 1500.0, false),
    (ESCAPE_BONUS_MINOR, 5604, 0, 30000, 1000.0, false),
    // Null-move threat-escape bonus in quiet ordering (was hardcoded 8000).
    (NULL_THREAT_ESCAPE_BONUS, 8154, 0, 30000, 1000.0, false),
