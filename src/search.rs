...
tunables!(
    ...
    (RFP_ROOT_COEF, 28, 0, 150, 7.5, true),
    ...
    (RAZOR_MULT, 280, 100, 500, 20.0, true),
    ...
    (LMR_HIST_DIV, 12614, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 2256, 1000, 20000, 1500.0, true),
    ...
    (PROBCUT_ROOT_MARGIN, 57, 0, 120, 8.0, true),
    ...
    (HIST_BONUS_MAX, 1503, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 271, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1355, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 313, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1814, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 266, 64, 1024, 40.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 74, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 969, 256, 4096, 192.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 64, 20, 90, 15.0, true),
    ...
    (LMR_ALPHA_RAISE_10X, 14, 0, 40, 5.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 36, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (SEE_CAP_MULT, 100, 40, 250, 12.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 46, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
