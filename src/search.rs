...
tunables!(
    ...
    (NMP_EVAL_DIV, 94, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 41, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 86, 40, 200, 20.0, true),
    ...
    (RFP_MARGIN_NOIMP, 46, 0, 200, 7.5, true),
    ...
    (LMR_HIST_DIV, 8190, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3756, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 153, 40, 300, 13.0, true),
    (LMR_C_CAP, 144, 80, 350, 12.5, true),
    ...
    (CORR_W_CONT, 20, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1606, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1949, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_BASE, 58, -50, 150, 6.0, true),
    (DEXT_CAP, 12, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (CORR_HIST_DIV, 1275, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 60, 20, 90, 15.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 41, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 0, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 56, 0, 400, 20.0, true),
    ...
    (CONT_HIST_MULT_10X, 12, 0, 80, 15.0, true),
    ...
    (BAD_NOISY_DEPTH, 7, 4, 15, 1.5, true),       // was hardcoded 4 (BNFP depth cap)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 17, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
