...
tunables!(
    ...
    (NMP_EVAL_DIV, 130, 50, 400, 17.5, true),
    ...
    (RAZOR_MULT, 296, 100, 500, 20.0, true),
    ...
    (LMR_HIST_DIV, 12628, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1429, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 136, 40, 300, 13.0, true),
    (LMR_C_CAP, 163, 80, 350, 12.5, true),
    ...
    (PROBCUT_ROOT_MARGIN, 60, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 166, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 71, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 320, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1533, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 312, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1794, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1395, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 293, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1752, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 259, 64, 1024, 40.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 66, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 1367, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 67, 20, 90, 15.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 59, 20, 90, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 16, 0, 200, 10.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 29, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_ROOT_MIN_DEPTH_10X, 35, 0, 80, 8.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 42, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
