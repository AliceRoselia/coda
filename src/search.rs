...
tunables!(
    ...
    (HIST_PRUNE_MULT, 11847, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7507, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 132, 40, 300, 13.0, true),
    (LMR_C_CAP, 121, 80, 350, 12.5, true),
    ...
    (SE_DEPTH_10X, 48, 40, 200, 20.0, true),
    ...
    (PROBCUT_MARGIN, 188, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 131, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 209, 50, 500, 22.5, false),
    (SEE_MATERIAL_SCALE, 228, 30, 300, 13.5, false),
    (QS_DELTA_MARGIN, 354, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -37, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 29, 2, 32, 2.0, false),
    (CORR_W_PAWN, 259, 100, 600, 25.0, true),
    (CORR_W_NP, 50, 50, 400, 17.5, true),
    (CORR_W_MINOR, 69, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 104, 30, 300, 13.5, true),
    (CORR_W_CONT, 43, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 311, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1747, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 271, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 37, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1786, 500, 3000, 125.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 52, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 21, 0, 50, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 26, 0, 400, 20.0, true),
    ...
    (LMR_ENDGAME_PIECES_10X, 45, 40, 90, 15.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 35, 30, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
