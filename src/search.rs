...
tunables!(
    ...
    (HIST_PRUNE_MULT, 8657, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8878, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 4569, 1000, 20000, 1500.0, true),
    ...
    (HIST_BONUS_MAX, 2024, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 291, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1904, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1584, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 45, 20, 90, 15.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 14, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
