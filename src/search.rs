...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 69, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 128, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 23, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 94, 40, 200, 20.0, true),
    (RFP_DEPTH, 16, 2, 20, 2.0, true),
    // Floors lifted to 0 (audit 2026-05-20): both pinned within ~10% of floor.
    (RFP_MARGIN_IMP, 45, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 58, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 9432, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8411, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 6028, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 147, 40, 300, 13.0, true),
    ...
    (CORR_W_PAWN, 308, 100, 600, 25.0, true),
    ...
    (HIST_BONUS_MULT, 308, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 2014, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1798, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_CORR, 24, 0, 64, 3.0, true),
    (DEXT_MARGIN_BASE, 42, -50, 150, 6.0, true),
    (DEXT_CAP, 15, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (CORR_HIST_DIV, 1464, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 15, 0, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 52, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 28, 0, 400, 20.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 62, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 20, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
