...
tunables!(
    ...
    (NMP_BASE_R_10X, 62, 20, 80, 15.0, true),
    (NMP_DEPTH_DIV_10X, 28, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 109, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 18, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 96, 40, 200, 20.0, true),
    (RFP_DEPTH, 16, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 42, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 85, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 43, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 80, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 13865, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8343, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 137, 40, 300, 13.0, true),
    (LMR_C_CAP, 103, 80, 350, 12.5, true),
    ...
    (ASP_SCORE_DIV, 30227, 8000, 50000, 2100.0, false),
    ...
    (LMP_DEPTH, 11, 4, 20, 2.0, true),
    (BAD_NOISY_MARGIN, 77, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 190, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 144, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 209, 50, 500, 22.5, false),
    (SEE_MATERIAL_SCALE, 228, 30, 300, 13.5, false),
    (QS_DELTA_MARGIN, 388, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -37, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 29, 2, 32, 2.0, false),
    (CORR_W_PAWN, 292, 100, 600, 25.0, true),
    (CORR_W_NP, 62, 50, 400, 17.5, true),
    (CORR_W_MINOR, 52, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 107, 30, 300, 13.5, true),
    (CORR_W_CONT, 55, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 328, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1737, 500, 3000, 125.0, true),
    ...
    (HIST_BONUS_OFFSET, 36, 0, 400, 25.0, false),
    (CAP_HIST_MULT, 268, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 37, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1744, 500, 3000, 125.0, true),
    ...
    (NFH_CAP_10X, 30, 10, 60, 10.0, false),
    (NFH_DIV_10X, 40, 20, 120, 10.0, false),
    ...
    (DEXT_MARGIN_PV, 201, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 6, 0, 100, 4.0, true),
    (DEXT_MARGIN_CORR, 13, 0, 64, 3.0, true),
    (DEXT_MARGIN_BASE, 46, -50, 150, 6.0, true),
    (DEXT_CAP, 12, 4, 32, 2.0, false),
    (QUIET_CHECK_BONUS, 11006, 2000, 30000, 1400.0, false),
    (LMR_COMPLEXITY_DIV, 182, 30, 500, 23.5, false),
    (CORR_HIST_DIV, 1219, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 13, 4, 48, 2.2, true),
    (CORR_BONUS_CAP_DIV_10X, 20, 10, 160, 15.0, false),
    (CORR_HIST_GRAIN_T, 11, 1, 32, 1.55, false),
    (CORR_HIST_ERR_MAX_10X, 10, 10, 640, 5.0, false),
    ...
    (ESCAPE_BONUS_R, 11199, 3000, 30000, 1350.0, false),
    ...
    (NMP_UNDEFENDED_MAX_10X, 19, 0, 50, 10.0, true),
    ...
    (MOBILITY_DELTA_WEIGHT, 38, 0, 256, 8.0, false),
    (PROBCUT_KING_ZONE_MAX_10X, 74, 20, 90, 15.0, true),
    (LMR_THREAT_DIV_10X, 49, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 59, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 6, 0, 200, 10.0, true),
    (DISCOVERED_ATTACK_BONUS, 6781, 0, 30000, 1500.0, false),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 15, 0, 400, 20.0, true),
    (MVV_CAP_MULT, 31, 4, 64, 3.0, false),
    (CONT_HIST_MULT_10X, 11, 10, 80, 15.0, true),
    (KNIGHT_FORK_BONUS, 9186, 0, 20000, 1000.0, false),
    ...
    (PROBCUT_MIN_DEPTH_10X, 31, 30, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (SEE_CAP_DEPTH, 6, 3, 15, 1.5, true),         // was hardcoded 6 (SEE capture prune depth cap)
    (FUT_LMR_DEPTH, 13, 5, 20, 1.5, false),        // was hardcoded 10; tune #743 → 9
    (BAD_NOISY_DEPTH, 14, 4, 15, 1.5, true),       // was hardcoded 4 (BNFP depth cap)
    ...
    (NMP_MIN_DEPTH_10X, 64, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 22, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
    (TT_CUTOFF_HALFMOVE_MAX, 88, 50, 100, 3.0, false),  // was hardcoded 90 (TT cutoff halfmove gate, 5 sites)
);
