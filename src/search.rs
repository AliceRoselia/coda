...
tunables!(
    ...
    (NMP_BASE_R_10X, 72, 20, 80, 15.0, true),
    ...
    (NMP_DEPTH_DIV_10X, 62, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 129, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 23, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 85, 40, 200, 20.0, true),
    ...
    (RFP_MARGIN_NOIMP, 52, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 6844, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 37, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7983, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5235, 1000, 20000, 1500.0, true),
    ...
    (PROBCUT_MARGIN, 179, 80, 300, 11.0, true),
    ...
    (CORR_W_CONT, 34, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1962, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 297, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1894, 500, 3000, 125.0, true),
    ...
    (DEXT_CAP, 15, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (CORR_HIST_DIV, 1621, 256, 4096, 192.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 83, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 49, 0, 400, 20.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 34, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 67, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 24, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
