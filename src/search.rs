...
tunables!(
    ...
    (HIST_PRUNE_MULT, 9979, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8194, 2000, 100000, 4900.0, true),
    ...
    (HIST_BONUS_MAX, 1971, 500, 3000, 125.0, true),
    ...
    (HIST_BONUS_OFFSET, 15, 0, 400, 25.0, false),
