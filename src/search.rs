...
tunables!(
    ...
    (CAP_HIST_MULT, 271, 50, 400, 17.5),
    (CAP_HIST_BASE, 35, 0, 200, 10.0),
    (CAP_HIST_MAX, 1656, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 10682, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 187, 30, 500, 23.5),
    (CORR_HIST_DIV, 1250, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15516, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10290, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5801, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5742, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7679, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6609, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 9347, 0, 20000, 1000.0),
