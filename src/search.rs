...
tunables!(
    ...
    (FH_BLEND_DEPTH_10X, 20, 0, 80, 15.0),
    ...
    (CORR_BONUS_CAP_DIV_10X, 10, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 13, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 30, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 18204, 5000, 40000, 1750.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5812, 0, 30000, 1500.0),
    ...
    (QSEE_BONUS, 5847, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 30, 0, 400, 20.0),
