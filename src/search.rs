...
tunables!(
    ...
    (NMP_EVAL_DIV, 135, 50, 400, 17.5, true),
    ...
    (RFP_MARGIN_IMP, 43, 0, 150, 6.0, true),
    ...
    (HIST_PRUNE_MULT, 11184, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8981, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5554, 1000, 20000, 1500.0, true),
    ...
    (QS_DELTA_MARGIN, 383, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -26, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 24, 2, 32, 2.0, false),
    (CORR_W_PAWN, 324, 100, 600, 25.0, true),
    ...
    (HIST_BONUS_MAX, 1925, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1993, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1455, 256, 4096, 192.0, true),
