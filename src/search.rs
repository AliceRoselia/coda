...
tunables!(
    ...
    (NMP_EVAL_MAX_10X, 39, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 53, 40, 200, 20.0, true),
    (RFP_DEPTH, 19, 2, 20, 2.0, true),
    // Floors lifted to 0 (audit 2026-05-20): both pinned within ~10% of floor.
    (RFP_MARGIN_IMP, 34, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 45, 0, 200, 7.5, true),
    ...
    (SEE_QUIET_MULT, 38, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7748, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3767, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 133, 40, 300, 13.0, true),
    (LMR_C_CAP, 158, 80, 350, 12.5, true),
    ...
    (BAD_NOISY_MARGIN, 90, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 152, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 196, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 302, 100, 500, 20.0, true),
    (QS_MAX_CAPTURES, 24, 2, 32, 2.0, false),
    (CORR_W_PAWN, 234, 100, 600, 25.0, true),
    ...
    (CAP_HIST_MULT, 279, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 2022, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1580, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 5, 4, 48, 2.2, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 80, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 1, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 31, 0, 400, 20.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 10, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (SEE_CAP_DEPTH, 3, 3, 15, 1.5, true),         // was hardcoded 6 (SEE capture prune depth cap)
