...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 54, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 30, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 93, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 11, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 12521, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8321, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 138, 40, 300, 13.0, true),
    (LMR_C_CAP, 124, 80, 350, 12.5, true),
    ...
    (ASP_SCORE_DIV, 34879, 8000, 50000, 2100.0, false),
    ...
    (UNSTABLE_THRESH, 296, 50, 500, 22.5, false),
    (SEE_MATERIAL_SCALE, 213, 30, 300, 13.5, false),
    (QS_DELTA_MARGIN, 377, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -20, -200, 0, 10.0, true),
    (QS_MAX_CAPTURES, 24, 2, 32, 2.0, false),
    (CORR_W_PAWN, 281, 100, 600, 25.0, true),
    (CORR_W_NP, 61, 50, 400, 17.5, true),
    (CORR_W_MINOR, 35, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 109, 30, 300, 13.5, true),
    (CORR_W_CONT, 33, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 46, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 321, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1961, 500, 3000, 125.0, true),
    ...
    (HIST_BONUS_OFFSET, 20, 0, 400, 25.0, false),
    (CAP_HIST_MULT, 306, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 46, 0, 200, 10.0, false),
    ...
    (NFH_CAP_10X, 25, 10, 60, 10.0, false),
    ...
    (DEXT_MARGIN_PV, 162, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 3, 0, 100, 4.0, true),
    (DEXT_MARGIN_CORR, 22, 0, 64, 3.0, true),
    (DEXT_MARGIN_BASE, 50, -50, 150, 6.0, true),
    (DEXT_CAP, 13, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14933, 2000, 30000, 1400.0, false),
    (LMR_COMPLEXITY_DIV, 175, 30, 500, 23.5, true),
    (CORR_HIST_DIV, 1542, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 13, 4, 48, 2.2, true),
    (CORR_BONUS_CAP_DIV_10X, 38, 10, 160, 15.0, false),
    (CORR_HIST_GRAIN_T, 14, 1, 32, 1.55, false),
    (CORR_HIST_ERR_MAX_10X, 23, 10, 640, 5.0, false),
    ...
    (ESCAPE_BONUS_R, 7236, 3000, 30000, 1350.0, false),
    (NMP_KING_ZONE_MAX_10X, 61, 20, 90, 15.0, true),
    ...
    (MOBILITY_DELTA_WEIGHT, 36, 0, 256, 8.0, false),
    (PROBCUT_KING_ZONE_MAX_10X, 63, 20, 90, 15.0, true),
    (LMR_THREAT_DIV_10X, 33, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 70, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 21, 0, 200, 10.0, true),
    (DISCOVERED_ATTACK_BONUS, 3750, 0, 30000, 1500.0, false),
    ...
    (KNIGHT_FORK_BONUS, 8036, 0, 20000, 1000.0, false),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 23, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
