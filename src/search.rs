...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 40, 10, 60, 15.0),
    ...
    (FUT_BASE, 25, 20, 200, 9.0),
    (FUT_PER_DEPTH, 96, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH_10X, 11, 10, 80, 15.0),
    (HIST_PRUNE_MULT, 13420, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 31, 5, 80, 3.75),
    (LMR_HIST_DIV, 7828, 2000, 100000, 4900.0),
    ...
    (SE_DEPTH_10X, 40, 40, 200, 20.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 33816, 8000, 50000, 2100.0),
    ...
    (HIST_BONUS_MAX, 1867, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 1, 0, 400, 25.0),
    (CAP_HIST_MULT, 309, 50, 400, 17.5),
    (CAP_HIST_BASE, 41, 0, 200, 10.0),
    (CAP_HIST_MAX, 1818, 500, 3000, 125.0),
    ...
    (ESCAPE_BONUS_Q, 18029, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 9456, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5524, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX_10X, 76, 20, 90, 15.0),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 63, 20, 90, 15.0),
    (LMR_THREAT_DIV_10X, 47, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV_10X, 74, 20, 90, 15.0),
    (FUT_THREATS_MARGIN, 20, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 3408, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8334, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6418, 0, 20000, 1000.0),
    ...
    (CONT_HIST_MULT_10X, 12, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 9298, 0, 20000, 1000.0),
