...
tunables!(
    ...
    (RFP_MARGIN_IMP, 41, 0, 150, 6.0, true),
    ...
    (HIST_PRUNE_MULT, 9539, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8548, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5072, 1000, 20000, 1500.0, true),
    ...
    (CORR_W_CONT, 28, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1680, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 283, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1887, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1596, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 85, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 25, 0, 50, 10.0, true),
    ...
    (FUT_THREATS_MARGIN, 8, 0, 200, 10.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 9, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
