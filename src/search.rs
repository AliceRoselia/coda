...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 59, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 9181, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 38, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7929, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 4804, 1000, 20000, 1500.0, true),
    ...
    (HINDSIGHT_THRESH, 162, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 31, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1672, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 275, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 42, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1910, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_QUIET, 8, 0, 100, 4.0, true),
    ...
    (CORR_HIST_DIV, 1512, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 22, 0, 50, 10.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 51, 20, 90, 15.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 12, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
