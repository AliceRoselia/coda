...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 65, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 140, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 19, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 93, 40, 200, 20.0, true),
    ...
    (RFP_MARGIN_NOIMP, 54, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 10152, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7859, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5813, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 139, 40, 300, 13.0, true),
    (LMR_C_CAP, 114, 80, 350, 12.5, true),
    ...
    (CORR_W_CONT, 26, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 302, 50, 400, 17.5, true),
    ...
    (CAP_HIST_MAX, 1935, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1644, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 76, 20, 90, 15.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 6, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 26, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
