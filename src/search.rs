...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 74, 10, 200, 15.0, true),
    ...
    (RFP_MARGIN_NOIMP, 36, 0, 200, 7.5, true),
    ...
    (LMR_HIST_DIV, 12783, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1934, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 146, 40, 300, 13.0, true),
    (LMR_C_CAP, 170, 80, 350, 12.5, true),
    ...
    (LMR_ROOT_COEF, 9, 0, 80, 4.0, true),
    (BAD_NOISY_MARGIN, 75, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 122, 80, 300, 11.0, true),
    ...
    (HIST_BONUS_MULT, 307, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1459, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 303, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1921, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 317, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1307, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 273, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1811, 500, 4000, 175.0, true),
    ...
    (DEXT_MARGIN_PV, 168, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 869, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 65, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 22, 1, 50, 10.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 66, 20, 90, 15.0, true),
    ...
    (LMR_ALPHA_RAISE_10X, 8, 0, 40, 5.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 53, 0, 400, 20.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 44, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 24, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (PROBCUT_ROOT_MIN_DEPTH_10X, 38, 0, 80, 8.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 48, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 31, 0, 200, 15.0, true),
