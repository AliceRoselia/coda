...
tunables!(
    ...
    (FUT_PER_DEPTH, 75, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 2, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 14034, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 7421, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 133, 40, 300, 13.0),
    (LMR_C_CAP, 100, 80, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 30063, 8000, 50000, 2100.0),
    (LMP_BASE, 9, 1, 15, 2.0),
    (LMP_DEPTH, 12, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 70, 30, 150, 6.0),
    (PROBCUT_MARGIN, 198, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 150, 50, 400, 17.5),
    (UNSTABLE_THRESH, 205, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 241, 30, 300, 13.5),
    ...
    (CAP_HIST_MAX, 1650, 500, 3000, 125.0),
    ...
    (ESCAPE_BONUS_Q, 15772, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10737, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5610, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6873, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7344, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6631, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8582, 0, 20000, 1000.0),
    ...
    (TT_CUTOFF_HALFMOVE_MAX, 86, 50, 100, 3.0),  // was hardcoded 90 (TT cutoff halfmove gate, 5 sites)
);
