...
tunables!(
    ...
    (RFP_MARGIN_IMP, 44, 0, 150, 6.0, true),
    ...
    (HIST_PRUNE_MULT, 8359, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7924, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5597, 1000, 20000, 1500.0, true),
    ...
    (CORR_W_CONT, 27, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1869, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1607, 256, 4096, 192.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 19, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
