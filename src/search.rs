...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 79, 50, 200, 7.5),
    ...
    (HIST_PRUNE_MULT, 12139, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 31, 5, 80, 3.75),
    (LMR_HIST_DIV, 7713, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 28566, 8000, 50000, 2100.0),
    ...
    (HIST_BONUS_MAX, 1708, 500, 3000, 125.0),
    ...
    (CAP_HIST_MULT, 284, 50, 400, 17.5),
    (CAP_HIST_BASE, 32, 0, 200, 10.0),
    (CAP_HIST_MAX, 1653, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 11800, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 180, 30, 500, 23.5),
    (CORR_HIST_DIV, 1189, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 14687, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10689, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5910, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6659, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7775, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6588, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8978, 0, 20000, 1000.0),
