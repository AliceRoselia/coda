...
tunables!(
    ...
    (RFP_ROOT_COEF, 31, 0, 150, 7.5, true),
    ...
    (RFP_DEEP_QUAD_10X, 37, 0, 800, 50.0, true),
    ...
    (RAZOR_MULT, 264, 100, 500, 20.0, true),
    ...
    (FUT_PER_DEPTH, 63, 40, 250, 10.5, true),
    ...
    (LMR_HIST_DIV, 18822, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 2850, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 156, 40, 300, 13.0, true),
    (LMR_C_CAP, 176, 80, 350, 12.5, true),
    ...
    (LMR_BASE_CENTI, 23, 0, 120, 6.0, true),
    (LMR_ALLNODE_DECAY_NUM, 654, 0, 1600, 80.0, true),
    ...
    (LMR_CUTNODE_BUMP_CENTI, 181, 100, 500, 40.0, true),
    ...
    (LMR_WINBETA_CENTI, 37, 0, 250, 12.0, true),
    (LMR_TTALPHA_CENTI, 28, 0, 150, 8.0, true),
    (LMR_TTDEPTH_CENTI, 11, 0, 150, 8.0, true),
    ...
    (LMR_CUTOFF_CNT_CENTI, 59, 0, 250, 12.0, true),
    ...
    // Bisecting 9 → 5 first.
    (LMP_BASE_10X, 31, 10, 150, 20.0, true),
    (LMP_DEPTH_10X, 78, 40, 200, 20.0, true),
    ...
    (LMR_ROOT_COEF_10X, 62, 0, 800, 40.0, true),
    ...
    (PROBCUT_ROOT_MARGIN, 66, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 191, 50, 400, 17.5, true),
    ...
    (CORR_W_TRANS, 54, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1479, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1762, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 324, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1304, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 308, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1990, 500, 4000, 175.0, true),
    ...
    (DEXT_MARGIN_QUIET, 16, 0, 100, 4.0, true),
    ...
    (CORR_HIST_DIV, 822, 256, 4096, 192.0, true),
    ...
    (LMR_THREAT_DIV_10X, 15, 10, 50, 15.0, true),
    // Was 68 (tp10→7). Now FIXED-POINT. Default 70 → eff 7.0 ≡ old behavior.
    (LMR_KING_PRESSURE_DIV_10X, 71, 20, 90, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 24, 0, 200, 10.0, true),
    ...
    (CONT_HIST_MULT_10X, 23, 0, 80, 15.0, true),
    ...
    (LMR_ENDGAME_PIECES_10X, 48, 45, 90, 15.0, true),
    ...
    (PROBCUT_ROOT_MIN_DEPTH_10X, 30, 0, 80, 8.0, true),
    (SEE_CAP_DEPTH_10X, 75, 30, 150, 15.0, true),         // was hardcoded 6 (SEE capture prune depth cap)
    ...
    (SEE_CAP_MULT, 83, 40, 250, 12.0, true),
    (SEE_CAP_HIST, 9, 0, 40, 2.0, true),
    (BAD_NOISY_DEPTH_10X, 79, 40, 150, 15.0, true),       // was hardcoded 4 (BNFP depth cap)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 37, 0, 200, 15.0, true),
