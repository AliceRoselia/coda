...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 57, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 158, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 25, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 102, 40, 200, 20.0, true),
    (RFP_DEPTH, 19, 2, 20, 2.0, true),
    // Floors lifted to 0 (audit 2026-05-20): both pinned within ~10% of floor.
    (RFP_MARGIN_IMP, 37, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 48, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 10980, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 42, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8394, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5712, 1000, 20000, 1500.0, true),
    ...
    (BAD_NOISY_MARGIN, 82, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 181, 80, 300, 11.0, true),
    ...
    (CORR_W_CONT, 32, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1785, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 305, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1661, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1619, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 28, 0, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 65, 20, 90, 15.0, true),
    // Was 38 (tp10→4). Now FIXED-POINT. Default 40 → eff 4.0 ≡ old behavior.
    (LMR_THREAT_DIV_10X, 37, 10, 50, 15.0, true),
    // Was 68 (tp10→7). Now FIXED-POINT. Default 70 → eff 7.0 ≡ old behavior.
    (LMR_KING_PRESSURE_DIV_10X, 38, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 27, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 35, 0, 400, 20.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 8, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 39, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (SEE_CAP_DEPTH, 7, 3, 15, 1.5, true),         // was hardcoded 6 (SEE capture prune depth cap)
    (BAD_NOISY_DEPTH, 6, 4, 15, 1.5, true),       // was hardcoded 4 (BNFP depth cap)
