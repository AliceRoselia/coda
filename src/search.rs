...
tunables!(
    ...
    (HIST_PRUNE_MULT, 13055, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 6835, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 138, 40, 300, 13.0),
    (LMR_C_CAP, 103, 80, 350, 12.5),
    (SE_DEPTH, 4, 2, 20, 2.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 30130, 8000, 50000, 2100.0),
    (LMP_BASE, 8, 1, 15, 2.0),
    (LMP_DEPTH, 11, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 75, 30, 150, 6.0),
    (PROBCUT_MARGIN, 196, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 151, 50, 400, 17.5),
    (UNSTABLE_THRESH, 207, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 238, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 343, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -35, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 28, 2, 32, 2.0),
    (CORR_W_PAWN, 290, 100, 600, 25.0),
    (CORR_W_NP, 87, 50, 400, 17.5),
    (CORR_W_MINOR, 72, 30, 300, 13.5),
    (CORR_W_MAJOR, 105, 30, 300, 13.5),
    (CORR_W_CONT, 36, 30, 400, 18.5),
    (FH_BLEND_DEPTH, 3, 0, 8, 1.5),
    (HIST_BONUS_MULT, 328, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1871, 500, 3000, 125.0),
    ...
    (CAP_HIST_MAX, 1644, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 12702, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 186, 30, 500, 23.5),
    (CORR_HIST_DIV, 1260, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15925, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 11103, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 6075, 2000, 20000, 900.0),
    ...
    (LMR_KING_PRESSURE_DIV, 7, 2, 9, 1.5),
    (FUT_THREATS_MARGIN, 22, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 6712, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7953, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6680, 0, 20000, 1000.0),
