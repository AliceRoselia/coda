...
tunables!(
    ...
    (RFP_ROOT_COEF, 26, 0, 150, 7.5, true),
    ...
    (LMR_HIST_DIV, 13522, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1253, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 143, 40, 300, 13.0, true),
    (LMR_C_CAP, 171, 80, 350, 12.5, true),
    ...
    (PROBCUT_ROOT_MARGIN, 71, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 197, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 378, 100, 500, 20.0, true),
    ...
    (HIST_BONUS_MAX, 1532, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1800, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1379, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 294, 64, 1024, 40.0, true),
    ...
    (CORR_HIST_DIV, 937, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 66, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 21, 1, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 82, 20, 90, 15.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 57, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 37, 0, 400, 20.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 38, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (SEE_CAP_MULT, 92, 40, 250, 12.0, true),
