...
tunables!(
    ...
    (NMP_BASE_R_10X, 68, 20, 80, 15.0),
    (NMP_DEPTH_DIV_10X, 50, 10, 60, 15.0),
    (NMP_EVAL_DIV, 113, 50, 400, 17.5),
    (NMP_EVAL_MAX_10X, 24, 10, 60, 5.0),
    (NMP_VERIFY_DEPTH_10X, 127, 40, 200, 20.0),
    (RFP_DEPTH, 16, 2, 20, 2.0),
    (RFP_MARGIN_IMP, 40, 30, 150, 6.0),
    (RFP_MARGIN_NOIMP, 68, 50, 200, 7.5),
    ...
    (HIST_PRUNE_MULT, 13603, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 7479, 2000, 100000, 4900.0),
    ...
    (SE_DEPTH_10X, 46, 40, 200, 20.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 33593, 8000, 50000, 2100.0),
    ...
    (BAD_NOISY_MARGIN, 79, 30, 150, 6.0),
    (PROBCUT_MARGIN, 182, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 163, 50, 400, 17.5),
    (UNSTABLE_THRESH, 302, 50, 500, 22.5),
    ...
    (CORR_W_MINOR, 49, 30, 300, 13.5),
    (CORR_W_MAJOR, 95, 30, 300, 13.5),
    (CORR_W_CONT, 34, 30, 400, 18.5),
    (FH_BLEND_DEPTH_10X, 28, 0, 80, 15.0),
    (HIST_BONUS_MULT, 291, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1920, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 4, 0, 400, 25.0),
    (CAP_HIST_MULT, 305, 50, 400, 17.5),
    (CAP_HIST_BASE, 36, 0, 200, 10.0),
    (CAP_HIST_MAX, 1792, 500, 3000, 125.0),
    ...
    (DEXT_CAP, 11, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 14304, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 147, 30, 500, 23.5),
    (CORR_HIST_DIV, 1347, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 11, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV_10X, 42, 10, 160, 15.0),
    (CORR_HIST_GRAIN_T, 14, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX_10X, 28, 10, 640, 5.0),
    (ESCAPE_BONUS_Q, 17612, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 8974, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5752, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX_10X, 72, 20, 90, 15.0),
    ...
    (NMP_UNDEFENDED_MAX_10X, 16, 0, 50, 10.0),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 52, 20, 90, 15.0),
    (LMR_THREAT_DIV_10X, 45, 10, 50, 15.0),
    (LMR_KING_PRESSURE_DIV_10X, 72, 20, 90, 15.0),
    (FUT_THREATS_MARGIN, 18, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 3108, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8512, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6275, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 47, 0, 400, 20.0),
    (MVV_CAP_MULT, 30, 4, 64, 3.0),
    (CONT_HIST_MULT_10X, 10, 10, 80, 15.0),
    (KNIGHT_FORK_BONUS, 8652, 0, 20000, 1000.0),
