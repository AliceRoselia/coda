...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 56, 10, 60, 15.0, true),
    ...
    (HIST_PRUNE_MULT, 9910, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8008, 2000, 100000, 4900.0, true),
    ...
    (PROBCUT_MARGIN, 180, 80, 300, 11.0, true),
    ...
    (CORR_W_PAWN, 297, 100, 600, 25.0, true),
    (CORR_W_NP, 63, 50, 400, 17.5, true),
    (CORR_W_MINOR, 13, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 3, 30, 300, 13.5, true),
    (CORR_W_CONT, 36, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 33, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 313, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1932, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1908, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 166, 50, 400, 15.0, true),
    ...
    (CORR_HIST_DIV, 1510, 256, 4096, 192.0, true),
    ...
    (LMR_THREAT_DIV_10X, 47, 10, 50, 15.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 28, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
