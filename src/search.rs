...
tunables!(
    ...
    (RFP_ROOT_COEF, 35, 0, 150, 7.5, true),
    ...
    (LMR_HIST_DIV, 12046, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1802, 1000, 20000, 1500.0, true),
    ...
    (PROBCUT_MARGIN_IMP, 42, 0, 120, 8.0, true),
    ...
    (HINDSIGHT_THRESH, 189, 50, 400, 17.5, true),
    ...
    (CORR_W_TRANS, 71, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1476, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 311, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1880, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 285, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1319, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 307, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1784, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 262, 64, 1024, 40.0, true),
    ...
    (CORR_HIST_DIV, 896, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 17, 1, 50, 10.0, true),
    ...
    (SEE_CAP_MULT, 89, 40, 250, 12.0, true),
