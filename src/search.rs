...
tunables!(
    ...
    (HIST_PRUNE_MULT, 9149, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 35, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8223, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5495, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 141, 40, 300, 13.0, true),
    (LMR_C_CAP, 115, 80, 350, 12.5, true),
    ...
    (HIST_BONUS_MAX, 1918, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 149, 50, 400, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 9, 0, 50, 10.0, true),
