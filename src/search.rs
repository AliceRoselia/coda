...
tunables!(
    ...
    (NMP_BASE_R_10X, 67, 20, 80, 15.0, true),
    (NMP_DEPTH_DIV_10X, 36, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 100, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 24, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 98, 40, 200, 20.0, true),
    (RFP_DEPTH, 17, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 36, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 84, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 46, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 80, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 13588, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7357, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 131, 40, 300, 13.0, true),
    (LMR_C_CAP, 104, 80, 350, 12.5, true),
    ...
    (LMP_DEPTH, 12, 4, 20, 2.0, true),
    (BAD_NOISY_MARGIN, 71, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 190, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 142, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 209, 50, 500, 22.5, false),
    (SEE_MATERIAL_SCALE, 228, 30, 300, 13.5, false),
    (QS_DELTA_MARGIN, 369, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -37, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 29, 2, 32, 2.0, false),
    (CORR_W_PAWN, 282, 100, 600, 25.0, true),
    (CORR_W_NP, 62, 50, 400, 17.5, true),
    (CORR_W_MINOR, 47, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 96, 30, 300, 13.5, true),
    (CORR_W_CONT, 50, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 326, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1745, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 277, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 37, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1752, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 198, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 7, 0, 100, 4.0, true),
    ...
    (CORR_HIST_DIV, 1265, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 50, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 16, 0, 50, 10.0, true),
    ...
    (LMR_THREAT_DIV_10X, 46, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 58, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 14, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 17, 0, 400, 20.0, true),
    ...
    (BAD_NOISY_DEPTH, 13, 4, 15, 1.5, true),       // was hardcoded 4 (BNFP depth cap)
    ...
    (NMP_MIN_DEPTH_10X, 69, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 36, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
