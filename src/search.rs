...
tunables!(
    ...
    (NMP_VERIFY_DEPTH_10X, 103, 40, 200, 20.0, true),
    ...
    (LMR_HIST_DIV, 14760, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1637, 1000, 20000, 1500.0, true),
    ...
    // (Rebased onto main 2026-06-26 for full --core retune; main's tuned 42
    // is superseded by the structural floor 6 and will be re-tuned here.)
    ...
    (HINDSIGHT_THRESH, 172, 50, 400, 17.5, true),
    ...
    (CORR_W_CONT, 84, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1423, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1902, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 283, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1389, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 302, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1763, 500, 4000, 175.0, true),
    ...
    (TEXT_MARGIN, 88, 0, 300, 12.0, true),
    ...
    (CORR_HIST_DIV, 1377, 256, 4096, 192.0, true),
    ...
    (LMR_ALPHA_RAISE_10X, 12, 0, 40, 5.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 22, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 14, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 41, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 24, 0, 200, 15.0, true),
