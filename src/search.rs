...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 76, 10, 200, 15.0, true),
    ...
    (RFP_MARGIN_NOIMP, 41, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 7428, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8577, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5489, 1000, 20000, 1500.0, true),
    ...
    (QS_DELTA_MARGIN, 326, 100, 500, 20.0, true),
    ...
    (CORR_W_CONT, 38, 0, 400, 18.5, true),
    ...
    (CAP_HIST_MAX, 1917, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1460, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 6, 4, 48, 2.2, true),
    ...
    (IIR_MIN_DEPTH_10X, 24, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 13, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 73, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 6, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
