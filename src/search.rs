...
tunables!(
    ...
    (HIST_PRUNE_MULT, 7241, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75),
    (LMR_HIST_DIV, 7535, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 134, 40, 300, 13.0),
    (LMR_C_CAP, 112, 80, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 28695, 8000, 50000, 2100.0),
    (LMP_BASE, 9, 1, 15, 2.0),
    ...
    (HIST_BONUS_MULT, 314, 50, 400, 17.5),
    ...
    (CAP_HIST_MAX, 1649, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_BASE, 37, -50, 150, 6.0),
    (DEXT_CAP, 12, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 10640, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 202, 30, 500, 23.5),
    (CORR_HIST_DIV, 1351, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15613, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10618, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5611, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6183, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7870, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 5791, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8962, 0, 20000, 1000.0),
