...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 40, 10, 60, 15.0, true),
    (NMP_EVAL_DIV, 110, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 20, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 90, 40, 200, 20.0, true),
    (RFP_DEPTH, 18, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 32, 30, 150, 6.0, true),
    ...
    (HIST_PRUNE_MULT, 14450, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7350, 2000, 100000, 4900.0, true),
    (LMR_C_QUIET, 139, 40, 300, 13.0, true),
    (LMR_C_CAP, 105, 80, 350, 12.5, true),
    ...
    (PROBCUT_MARGIN, 194, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 140, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 209, 50, 500, 22.5, false),
    (SEE_MATERIAL_SCALE, 228, 30, 300, 13.5, false),
    (QS_DELTA_MARGIN, 363, 100, 500, 20.0, true),
    (QS_SEE_THRESHOLD, -37, -200, 0, 10.0, false),
    (QS_MAX_CAPTURES, 29, 2, 32, 2.0, false),
    (CORR_W_PAWN, 273, 100, 600, 25.0, true),
    (CORR_W_NP, 69, 50, 400, 17.5, true),
    (CORR_W_MINOR, 58, 30, 300, 13.5, true),
    (CORR_W_MAJOR, 96, 30, 300, 13.5, true),
    (CORR_W_CONT, 44, 30, 400, 18.5, true),
    (FH_BLEND_DEPTH_10X, 30, 0, 80, 15.0, false),
    (HIST_BONUS_MULT, 321, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1702, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 278, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 37, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 1674, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 196, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 6, 0, 100, 4.0, true),
    (DEXT_MARGIN_CORR, 15, 0, 64, 3.0, true),
    (DEXT_MARGIN_BASE, 43, -50, 150, 6.0, true),
    (DEXT_CAP, 12, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 11006, 2000, 30000, 1400.0, false),
    (LMR_COMPLEXITY_DIV, 184, 30, 500, 23.5, true),
    (CORR_HIST_DIV, 1216, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 11, 4, 48, 2.2, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 20, 0, 50, 10.0, true),
    ...
    (LMR_THREAT_DIV_10X, 50, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 60, 20, 90, 15.0, true),
    ...
    (FUT_LMR_DEPTH, 14, 5, 20, 1.5, true),         // was hardcoded 10; tune #743 → 9
    ...
    (NMP_MIN_DEPTH_10X, 70, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    (HINDSIGHT_MIN_DEPTH_10X, 30, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
