...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 73, 10, 200, 15.0, true),
    ...
    (RFP_MARGIN_IMP, 51, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 61, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 9272, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8980, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3239, 1000, 20000, 1500.0, true),
    ...
    (PROBCUT_MARGIN, 182, 80, 300, 11.0, true),
    ...
    (CORR_W_PAWN, 306, 100, 600, 25.0, true),
    ...
    (HIST_BONUS_MAX, 2062, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1501, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 86, 20, 90, 15.0, true),
    ...
    (CONT_HIST_MULT_10X, 15, 0, 80, 15.0, true),
