...
tunables!(
    ...
    (RFP_MARGIN_IMP, 25, 0, 150, 6.0, true),
    ...
    (RAZOR_MULT, 285, 100, 500, 20.0, true),
    ...
    (LMR_HIST_DIV, 12414, 2000, 100000, 4900.0, true),
    ...
    (PROBCUT_MARGIN_IMP, 40, 0, 120, 8.0, true),
    ...
    (PROBCUT_ROOT_MARGIN, 64, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 196, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 366, 100, 500, 20.0, true),
    ...
    (CORR_W_PAWN, 320, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 90, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 303, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1429, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 310, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1846, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 303, 50, 900, 40.0, true),
    ...
    (CAP_HIST_MALUS_MAX, 1805, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 263, 64, 1024, 40.0, true),
    ...
    (CORR_HIST_DIV, 701, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 64, 20, 90, 15.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 84, 20, 90, 15.0, true),
    ...
    (CONT_HIST_MULT_10X, 24, 0, 80, 15.0, true),
    ...
    (PROBCUT_ROOT_MIN_DEPTH_10X, 42, 0, 80, 8.0, true),
    ...
    (SEE_CAP_MULT, 93, 40, 250, 12.0, true),
