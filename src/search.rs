...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 64, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 145, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 27, 10, 60, 5.0, true),
    ...
    (RFP_MARGIN_NOIMP, 63, 0, 200, 7.5, true),
    ...
    (FUT_BASE, 31, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 75, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 5628, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8419, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3002, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 132, 40, 300, 13.0, true),
    (LMR_C_CAP, 125, 80, 350, 12.5, true),
    ...
    // Bisecting 9 → 5 first.
    (LMP_BASE, 12, 1, 15, 2.0, true),
    (LMP_DEPTH, 4, 4, 20, 2.0, true),
    (BAD_NOISY_MARGIN, 76, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 215, 80, 300, 11.0, true),
    (HINDSIGHT_THRESH, 157, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 327, 100, 500, 20.0, true),
    (QS_MAX_CAPTURES, 24, 2, 32, 2.0, false),
    (CORR_W_PAWN, 315, 100, 600, 25.0, true),
    // Floor lifted from 50 → 0 (audit 2026-05-20): pinned at 63, 4% from floor.
    (CORR_W_NP, 54, 0, 400, 17.5, true),
    ...
    (HIST_BONUS_MULT, 292, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 2010, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 323, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 2071, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 130, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 1, 0, 100, 4.0, true),
    (DEXT_MARGIN_CORR, 28, 0, 64, 3.0, true),
    (DEXT_MARGIN_BASE, 49, -50, 150, 6.0, true),
    (DEXT_CAP, 14, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (CORR_HIST_DIV, 1688, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 89, 20, 90, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 32, 0, 50, 10.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 50, 20, 90, 15.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 86, 20, 90, 15.0, true),
    ...
    (LMR_ENDGAME_PIECES_10X, 52, 45, 90, 15.0, true),
    ...
    (PROBCUT_MIN_DEPTH_10X, 28, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 65, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 0, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
