...
tunables!(
    ...
    (HIST_PRUNE_MULT, 11413, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 7221, 2000, 100000, 4900.0),
    ...
    (ASP_SCORE_DIV, 29461, 8000, 50000, 2100.0),
    ...
    (BAD_NOISY_MARGIN, 69, 30, 150, 6.0),
    ...
    (QS_DELTA_MARGIN, 344, 100, 500, 20.0),
    ...
    (HIST_BONUS_MAX, 1751, 500, 3000, 125.0),
    ...
    (CAP_HIST_BASE, 34, 0, 200, 10.0),
    (CAP_HIST_MAX, 1662, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 205, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 9, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 12, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 42, -50, 150, 6.0),
    (DEXT_CAP, 12, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 11051, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 190, 30, 500, 23.5),
    (CORR_HIST_DIV, 1316, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_R, 10414, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5947, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6008, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7569, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6169, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8630, 0, 20000, 1000.0),
