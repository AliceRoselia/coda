...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 80, 10, 200, 15.0, true),
    ...
    (RFP_ROOT_COEF, 32, 0, 150, 7.5, true),
    ...
    (RAZOR_MULT, 283, 100, 500, 20.0, true),
    ...
    (FUT_PER_DEPTH, 83, 40, 250, 10.5, true),
    ...
    (LMR_HIST_DIV, 8820, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 2373, 1000, 20000, 1500.0, true),
    ...
    (CORR_W_CONT, 76, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 293, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1559, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1869, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1464, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 318, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1924, 500, 4000, 175.0, true),
    ...
    (CORR_HIST_DIV, 1611, 256, 4096, 192.0, true),
    ...
    (NMP_KING_ZONE_MAX_10X, 84, 20, 90, 15.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 34, 0, 400, 20.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 28, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 16, 0, 200, 15.0, true),
