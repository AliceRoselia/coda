...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 81, 10, 200, 15.0, true),
    ...
    (RFP_DEEP_LINEAR, 67, 0, 200, 10.0, true),
    ...
    (RAZOR_MULT, 269, 100, 500, 20.0, true),
    ...
    (FUT_PER_DEPTH, 109, 40, 250, 10.5, true),
    ...
    (LMR_HIST_DIV, 7905, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3123, 1000, 20000, 1500.0, true),
    ...
    (PROBCUT_MARGIN, 115, 80, 300, 11.0, true),
    ...
    (CORR_W_CONT, 77, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1543, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1488, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 311, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1859, 500, 4000, 175.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 17, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (NMP_MIN_DEPTH_10X, 34, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
