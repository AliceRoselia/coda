...
tunables!(
    ...
    (EVAL_CLIP_THRESHOLD, 608, 200, 2000, 50.0),
    (HIST_PRUNE_DEPTH, 3, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 13003, 500, 50000, 2475.0),
    ...
    (UNSTABLE_THRESH, 213, 50, 500, 22.5),
    ...
    (HIST_BONUS_MAX, 1765, 500, 3000, 125.0),
    ...
    (CAP_HIST_MULT, 274, 50, 400, 17.5),
    (CAP_HIST_BASE, 40, 0, 200, 10.0),
    (CAP_HIST_MAX, 1651, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 12009, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 187, 30, 500, 23.5),
    (CORR_HIST_DIV, 1270, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 15843, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10502, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5750, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 5799, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7337, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6583, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8861, 0, 20000, 1000.0),
