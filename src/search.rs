...
tunables!(
    ...
    (LMR_HIST_DIV, 11577, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1710, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 145, 40, 300, 13.0, true),
    (LMR_C_CAP, 168, 80, 350, 12.5, true),
    ...
    (PROBCUT_ROOT_MARGIN, 61, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 194, 50, 400, 17.5, true),
    ...
    (CORR_W_PAWN, 322, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 78, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 1477, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 319, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1873, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1324, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 282, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1741, 500, 4000, 175.0, true),
    ...
    (DEXT_MARGIN_PV, 159, 50, 400, 15.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 71, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 924, 256, 4096, 192.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 27, 1, 50, 10.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 49, 20, 90, 15.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 41, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_ROOT_MIN_DEPTH_10X, 36, 0, 80, 8.0, true),
    (SEE_CAP_DEPTH, 9, 3, 15, 1.5, true),         // was hardcoded 6 (SEE capture prune depth cap)
    ...
    (SEE_CAP_MULT, 95, 40, 250, 12.0, true),
    (SEE_CAP_HIST, 13, 0, 40, 2.0, true),
