...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 36, 10, 200, 15.0, true),
    ...
    (FUT_PER_DEPTH, 68, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 11949, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 7598, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5482, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 130, 40, 300, 13.0, true),
    (LMR_C_CAP, 93, 80, 350, 12.5, true),
    ...
    (CORR_W_PAWN, 332, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 11, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 295, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1958, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1974, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1473, 256, 4096, 192.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 30, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
