...
tunables!(
    ...
    (NMP_VERIFY_DEPTH_10X, 127, 40, 200, 20.0, true),
    (RFP_DEPTH, 15, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 42, 30, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 58, 50, 200, 7.5, true),
    ...
    (FUT_BASE, 25, 20, 200, 9.0, true),
    (FUT_PER_DEPTH, 78, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 7804, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 36, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 10076, 2000, 100000, 4900.0, true),
    ...
    (PROBCUT_MARGIN, 191, 80, 300, 11.0, true),
    ...
    (CORR_W_PAWN, 313, 100, 600, 25.0, true),
    (CORR_W_NP, 76, 50, 400, 17.5, true),
    (CORR_W_MINOR, 44, 30, 300, 13.5, true),
    ...
    (HIST_BONUS_MAX, 1960, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MAX, 1879, 500, 3000, 125.0, true),
    ...
    (CORR_HIST_DIV, 1538, 256, 4096, 192.0, true),
    ...
    (FUT_THREATS_MARGIN, 28, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 59, 0, 400, 20.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 13, 10, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
