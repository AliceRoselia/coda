...
tunables!(
    ...
    (NMP_VERIFY_DEPTH_10X, 109, 40, 200, 20.0, true),
    ...
    (RFP_MARGIN_NOIMP, 56, 0, 200, 7.5, true),
    ...
    (HIST_PRUNE_MULT, 9617, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 6877, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5466, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 138, 40, 300, 13.0, true),
    (LMR_C_CAP, 118, 80, 350, 12.5, true),
    ...
    (HIST_BONUS_MAX, 1933, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 280, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1841, 500, 3000, 125.0, true),
    ...
    (DEXT_CAP, 16, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (CORR_HIST_DIV, 1866, 256, 4096, 192.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 56, 20, 90, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 37, 0, 200, 10.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 7, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 28, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
);
