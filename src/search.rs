...
tunables!(
    ...
    (NMP_BASE_R_10X, 63, 20, 80, 15.0, true),
    ...
    (NMP_DEPTH_DIV_10X, 29, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 165, 50, 400, 17.5, true),
    (NMP_EVAL_MAX_10X, 23, 10, 60, 5.0, true),
    (NMP_VERIFY_DEPTH_10X, 100, 40, 200, 20.0, true),
    (RFP_DEPTH, 14, 2, 20, 2.0, true),
    // Floors lifted to 0 (audit 2026-05-20): both pinned within ~10% of floor.
    (RFP_MARGIN_IMP, 38, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 60, 0, 200, 7.5, true),
    ...
    (FUT_PER_DEPTH, 82, 40, 250, 10.5, true),
    (HIST_PRUNE_DEPTH_10X, 10, 10, 80, 15.0, true),
    (HIST_PRUNE_MULT, 9657, 500, 50000, 2475.0, true),
    (SEE_QUIET_MULT, 29, 5, 80, 3.75, true),
    (LMR_HIST_DIV, 8367, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 4047, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 133, 40, 300, 13.0, true),
    (LMR_C_CAP, 109, 80, 350, 12.5, true),
    ...
    (SE_DEPTH_10X, 46, 40, 200, 20.0, true),
    ...
    (CORR_W_CONT, 40, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MAX, 2126, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 301, 50, 400, 17.5, true),
    (CAP_HIST_BASE, 42, 0, 200, 10.0, false),
    (CAP_HIST_MAX, 2064, 500, 3000, 125.0, true),
    ...
    (DEXT_MARGIN_PV, 152, 50, 400, 15.0, true),
    (DEXT_MARGIN_QUIET, 1, 0, 100, 4.0, true),
    (DEXT_MARGIN_CORR, 21, 0, 64, 3.0, true),
    (DEXT_MARGIN_BASE, 46, -50, 150, 6.0, true),
    (DEXT_CAP, 17, 4, 32, 2.0, true),
    (QUIET_CHECK_BONUS, 14805, 2000, 30000, 1400.0, false),
    (LMR_COMPLEXITY_DIV, 152, 30, 500, 23.5, false),
    (CORR_HIST_DIV, 1634, 256, 4096, 192.0, true),
    (CORR_UPDATE_WEIGHT_MAX, 9, 4, 48, 2.2, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 66, 20, 90, 15.0, true),
    ...
    (LMR_KING_PRESSURE_DIV_10X, 47, 20, 90, 15.0, true),
    (FUT_THREATS_MARGIN, 15, 0, 200, 10.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 5, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 19, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    ...
    (NMP_MIN_DEPTH_10X, 76, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    // Floor lifted from 10 → 0 (audit 2026-05-20): pinned at 25, 8% from floor.
    (HINDSIGHT_MIN_DEPTH_10X, 38, 0, 200, 15.0, true),        // was hardcoded 2 (hindsight reduction gate)
