...
tunables!(
    ...
    (NMP_VERIFY_DEPTH_10X, 107, 40, 200, 20.0, true),
    ...
    (RFP_ROOT_COEF, 25, 0, 150, 7.5, true),
    ...
    (RAZOR_MULT, 305, 100, 500, 20.0, true),
    ...
    (LMR_HIST_DIV, 12098, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1178, 1000, 20000, 1500.0, true),
    ...
    (PROBCUT_MARGIN_IMP, 35, 0, 120, 8.0, true),
    ...
    (PROBCUT_ROOT_MARGIN, 58, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 161, 50, 400, 17.5, true),
    ...
    (HIST_BONUS_MULT, 319, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1525, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 300, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1850, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MAX, 1406, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 308, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1721, 500, 4000, 175.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 77, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 1395, 256, 4096, 192.0, true),
    ...
    (SEE_CAP_MULT, 118, 40, 250, 12.0, true),
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 12, 0, 200, 15.0, true),
